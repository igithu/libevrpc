...
class CenterCluster : public ::google::protobuf::Message {
 public:
  CenterCluster();
  virtual ~CenterCluster();

  CenterCluster(const CenterCluster& from);

  inline CenterCluster& operator=(const CenterCluster& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const CenterCluster& default_instance();

  void Swap(CenterCluster* other);

  // implements Message ----------------------------------------------

  CenterCluster* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CenterCluster& from);
  void MergeFrom(const CenterCluster& from);
  void Clear();
  ...
  // @@protoc_insertion_point(class_scope:libevrpc.CenterCluster)
 private:
  ...
  static CenterCluster* default_instance_;
};
// ===================================================================
